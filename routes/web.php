...
Route::middleware(LoggerMiddleware::class)->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        Route::get('/user/personal_cabinet', [CabinetController::class, 'index'])->name('user.personal.pages');
    ...
    Route::middleware(AccessMiddleware::class)->group(function (){
        ...
        Route::get('/sweet_panel/users', [DashboardController::class, 'index'])->name('admin.users');
        Route::get('/sweet_panel/settings', [DashboardController::class, 'index'])->name('admin.settings');
        Route::get('/sweet_panel/store', [DashboardController::class, 'index'])->name('admin.store');
        Route::get('/sweet_panel/integrations', [DashboardController::class, 'index'])->name('admin.integrations');
    });
});
